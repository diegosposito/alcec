...
abstract class BaseSfGuardUserGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%=username%% - %%created_at%% - %%updated_at%% - %%last_login%% - %%sede%% - %%area%%';
  }
  ...
  {
    return 'Edicion de usuario: "%%username%%"';
  }
  ...
  {
    return array(  0 => 'first_name',  1 => 'last_name',  2 => 'email_address',);
  }

  public function getFormDisplay()
  {
    return array(  'Usuario' =>   array(    0 => 'first_name',    1 => 'last_name',    2 => 'email_address',    3 => 'username',    4 => 'password',    5 => 'password_again',  ),  'Datos personales' =>   array(    0 => 'Profile',  ),  'Permisos y grupos' =>   array(    0 => 'is_active',    1 => 'is_super_admin',    2 => 'groups_list',    3 => 'permissions_list',  ),);
  }
  ...
  {
    return array(  0 => '=username',  1 => 'created_at',  2 => 'updated_at',  3 => 'last_login',  4 => 'sede',  5 => 'area',);
  }
  ...
  public function getFieldsDefault()
  {
    return array(
      ...
      'last_login' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Date',  'label' => 'Ultimo Acceso',  'date_format' => 'dd/M/yyyy hh:mm',),
      'created_at' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Date',  'label' => 'Creado',  'date_format' => 'dd/M/yyyy',),
      'updated_at' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Date',  'label' => 'Actualizado',  'date_format' => 'dd/M/yyyy',),
      ...
      'password_again' => array(  'is_link' => false,  'is_real' => false,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',  'label' => 'Contraseña (confirmacion)',),
    );
  }
  ...
  public function getFieldsForm()
  {
    return array(
      ...
      'salt' => array(),
      'password' => array(),
      'is_active' => array(  'credentials' =>   array(    0 => 'alumno',  ),),
      'is_super_admin' => array(  'credentials' =>   array(    0 => 'academica',  ),),
      'last_login' => array(),
      'created_at' => array(),
      'updated_at' => array(),
      'groups_list' => array(),
      'permissions_list' => array(),
      'grupos' => array(  'credentials' =>   array(    0 => 'admin',  ),),
      'permisos' => array(  'credentials' =>   array(    0 => 'admin',  ),),
    );
  }
